...
#     model = CatBoostRegressor(max_depth = int(max_depth), # 실수값 전달로 인해 에류 발생 정수값으로 변환해야한다.
#                               learning_rate = learning_rate,
#                               iterations   = int(iterations), # 실수값 전달로 인해 에류 발생 정수값으로 변환해야한다.
#                               l2_leaf_reg = l2_leaf_reg,
#                               border_count  = int(border_count), # 실수값 전달로 인해 에류 발생 정수값으로 변환해야한다.
#                               subsample  = subsample,
