...
csv_to_parquet('c:/study/_data/dacon_air/', 'train')
csv_to_parquet('c:/study/_data/dacon_air/', 'test')

train = pd.read_parquet('c:/study/_data/dacon_air/train.parquet')
test = pd.read_parquet('c:/study/_data/dacon_air/test.parquet')
...
submission.to_csv('c:/study/_data/dacon_air/submit.csv', index=True)
