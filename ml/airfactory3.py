...
path='c:/study/_data/pm2.5/'
path_save = 'c:/study/_save/pm2.5/'
...
train_pm_path = 'c:/study/_data/pm2.5/TRAIN/'
train_aws_path = 'c:/study/_data/pm2.5/TRAIN_AWS/'
test_pm_path = 'c:/study/_data/pm2.5/TEST_INPUT/'
test_aws_path = 'c:/study/_data/pm2.5/TEST_AWS/'
...
pd.DataFrame(train_pm).to_csv(path_save+'0685.csv',encoding='UTF-8')