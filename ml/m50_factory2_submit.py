...
path_train = "c:/study/_data/_data/aifact_05/TRAIN/"
path_train_aws = "c:/study/_data/_data/aifact_05/TRAIN_AWS/"
path_test = "c:/study/_data/_data/aifact_05/TEST/"
path_test_aws = "c:/study/_data/_data/aifact_05/TEST_AWS/"
path_META = "c:/study/_data/_data/aifact_05/META/"
path_save = "c:/study/_save/aifact_05/"
path_data_imputer = "c:/study/_data/_data/aifact_05/train_pd_inter/"
path_data_inter = "c:/study/_data/_data/aifact_05/train_pd_inter/"
...
x_train,x_test, y_train, y_test = train_test_split(
    x,y,test_size = 0.2, random_state=23456,# 랜덤 스테이트 바꾸기 
...
parameter =  {
    ...
    # "random_state":3378, # 디폴트 1 / 0 ~ inf / L2 제곱 가중치 규제 / lambda
    # "verbose":0, 
    "n_jobs" : -1
}
...
submission_csv.to_csv(path_save + '1234_11.csv',encoding='utf-8')  

# model.score :  0.22648426955391188
# r2 :  0.22648426955391188
# mae :  0.04404054929628806

# 1234_10
# 걸린 시간 :  16.17 초
# model.score :  0.22900815919957918
# r2 :  0.22900815919957918
# mae :  0.04415561846417493

# 1234_11
# model.score :  0.22900515506990693
# r2 :  0.22900515506990693
# mae :  0.043909957289781476
